defmodule GnomeGardenWeb.Agents.Sales.LeadSourcesLive do
  ...
  defp config_badge(_status), do: "badge badge-ghost badge-sm"

  defp source_status_badge(:candidate), do: "badge badge-warning badge-sm"
  defp source_status_badge(:approved), do: "badge badge-success badge-sm"
  defp source_status_badge(:ignored), do: "badge badge-ghost badge-sm"
  defp source_status_badge(:blocked), do: "badge badge-error badge-sm"
  defp source_status_badge(_status), do: "badge badge-ghost badge-sm"

  defp enabled_badge(true), do: "badge badge-success badge-sm"
  defp enabled_badge(false), do: "badge badge-ghost badge-sm"
