defmodule GnomeGardenWeb.Agents.Sales.ProcurementTargetingLive do
      ...
      <div class="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        >
            ...
            <div class="space-y-3">
              ...
              <div class="flex justify-end">
                <.button type="submit" variant="primary">
                  <.icon name="hero-plus" class="size-4" /> Add Excludes
                </.button>
              </div>
            </div>
          </.form>
          ...
          <div class="mt-6 space-y-4">
            <div>
              <h3 class="text-sm font-semibold text-zinc-900 dark:text-white">Fixed Excludes</h3>
            ...
            <div>
              <h3 class="text-sm font-semibold text-zinc-900 dark:text-white">Learned Excludes</h3>
            ...
            <div>
              <h3 class="text-sm font-semibold text-zinc-900 dark:text-white">Include Keywords</h3>
              <div class="mt-2 flex flex-wrap gap-2">
                <span
