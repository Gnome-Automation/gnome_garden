defmodule GnomeGardenWeb.Finance.BankingReviewLive do
  ...
  def handle_event("open_category", %{"id" => id}, socket) do
    transaction = Banking.get_bank_transaction!(id, actor: socket.assigns.current_user)
  ...
  defp assign_queue_summary(socket) do
    transactions =
      Banking.list_bank_transactions_needing_review!(actor: socket.assigns.current_user)
      |> page_results()
