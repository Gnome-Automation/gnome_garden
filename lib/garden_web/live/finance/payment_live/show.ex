    ...
    <.page class="pb-8">
      <.page_header eyebrow="Finance">
        ...
        <:actions>
          ...
          <a href={~p"/finance/payments/#{@payment}/export?format=csv"} target="_blank" rel="external" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-white/10 dark:text-white dark:ring-white/20 dark:hover:bg-white/20">
