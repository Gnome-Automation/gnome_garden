          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-6">
            ...
            <div class="sm:col-span-4">
              ...
              <p class="mt-1.5 text-xs text-base-content/50">
                ...
                <.link navigate={~p"/operations/organizations/new?return_to=#{~p"/commercial/signals/new"}"} class="underline text-emerald-600 dark:text-emerald-400">Create one first</.link>.
              </p>
            </div>
            <div class="sm:col-span-3">
