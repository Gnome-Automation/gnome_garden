defmodule GnomeGarden.Banking.BankCounterpartyAlias do
  @moduledoc """
  Provider-neutral alias mapping a bank transaction counterparty name to an
  Operations.Organization, so reconciliation can resolve messy wire/ACH
  counterparty strings to a known org.
  """
  ...
  postgres do
    table "banking_counterparty_aliases"
    repo GnomeGarden.Repo
    identity_index_names unique_normalized_counterparty: "banking_counterparty_uidx"
  ...
  actions do
    ...
    create :create do
      primary? true
      accept [:counterparty_name, :normalized_name, :organization_id, :confidence, :source, :status]
    end
