defmodule GnomeGarden.Commercial.Changes.NormalizeDiscoveryRecordWebsite do
  @moduledoc """
  Normalizes discovery-record websites and persists the derived website domain.
  """
