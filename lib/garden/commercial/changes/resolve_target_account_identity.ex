defmodule GnomeGarden.Commercial.Changes.ResolveTargetAccountIdentity do
  @moduledoc """
  Links a target account to the correct organization and contact person.
  """
