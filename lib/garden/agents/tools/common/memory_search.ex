defmodule GnomeGarden.Agents.Tools.MemorySearch do
  @moduledoc """
  ...
  use Jido.Action,
    name: "memory_search",
    description:
      "Find all memories in a specific namespace. Use to retrieve organized groups of memories.",
    schema: [
      namespace: [
        type: :string,
        required: true,
        doc: "The namespace to search (e.g., 'project_x', 'global')"
      ]
    ]
