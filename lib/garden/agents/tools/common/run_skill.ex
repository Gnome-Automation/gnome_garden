defmodule GnomeGarden.Agents.Tools.RunSkill do
  @moduledoc """
  ...
  def run(params, _context) do
    ...
    # Load skill from YAML file in .gnome_garden/skills/
    skill_path = Path.join([".gnome_garden", "skills", "#{skill_name}.yaml"])
