defmodule GnomeGarden.Agents.Tools.Reason do
  @moduledoc """
  ...
  use Jido.Action,
    name: "reason",
    description:
      "Use structured reasoning to think through a problem step by step. Good for complex decisions, debugging, or planning.",
    schema: [
      ...
      strategy: [
        ...
        doc: "Reasoning strategy: chain_of_thought, pros_cons, or systematic"
      ]
    ]
