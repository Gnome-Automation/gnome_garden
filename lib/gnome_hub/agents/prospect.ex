defmodule GnomeHub.Agents.Prospect do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :industry, :atom,
      public?: true,
      constraints: [one_of: [
        :brewery, :food_bev, :biotech, :pharma, :water, :wastewater,
        :packaging, :warehouse, :plastics, :aerospace, :cosmetics, :other
      ]]
    ...
    attribute :signals, {:array, :string}, default: [], public?: true,
    ...
    attribute :tech_indicators, {:array, :string}, default: [], public?: true,
      description: "e.g., 'Rockwell', 'Ignition', 'SLC 500', 'PanelView Plus 6'"

    # Contacts
    attribute :contacts, {:array, :map}, default: [], public?: true,
      description: "List of contact info: [{name, title, email, linkedin}]"

    # Discovery
    attribute :discovered_via, :string, public?: true,
  ...
  actions do
    ...
    create :create do
      primary? true
      accept [:name, :website, :location, :region, :industry, :size,
              :signals, :signal_strength, :tech_indicators,
              :discovered_via, :discovery_url, :notes, :metadata]
    ...
    update :update do
      accept [:status, :signals, :signal_strength, :tech_indicators,
              :contacts, :notes, :next_action, :next_action_date, :metadata]
    end
