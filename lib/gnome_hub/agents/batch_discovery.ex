defmodule GnomeHub.Agents.BatchDiscovery do
  @moduledoc """
  ...
  alias GnomeHub.Agents.Tools.Browser.Navigate
  alias GnomeHub.Agents.Tools.SaveDiscovery
  ...
  def discover_all_planetbids do
    ...
    Logger.info("Batch discovery complete: #{length(discovered)} succeeded, #{length(failed)} failed")
