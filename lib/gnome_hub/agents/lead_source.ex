defmodule GnomeHub.Agents.LeadSource do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :source_type, :atom,
      allow_nil?: false,
      public?: true,
      constraints: [one_of: [:planetbids, :opengov, :sam_gov, :cal_eprocure, :utility, :school, :port, :custom]]

    attribute :portal_id, :string, public?: true, description: "External portal ID (e.g., PlanetBids portal number)"
    ...
    attribute :scrape_selector, :string, public?: true, description: "CSS selector for bid listings if scraping"

    # Discovered scraping configuration (populated by SmartScanner)
    attribute :scrape_config, :map, default: %{}, public?: true, description: """
    ...
    attribute :metadata, :map, default: %{}, public?: true, description: "Additional config: API keys, endpoints, etc."
  ...
  actions do
    ...
    create :create do
      primary? true
      accept [:name, :url, :source_type, :portal_id, :region, :priority,
              :api_available, :requires_login, :scrape_selector,
              :scan_frequency_hours, :enabled, :metadata, :discovered_by, :discovery_notes]
    end

    update :update do
      accept [:name, :url, :priority, :enabled, :scan_frequency_hours,
              :scrape_selector, :scrape_config, :metadata, :last_scanned_at,
              :discovery_status, :discovered_at]
    end
