defmodule GnomeHub.Agents.Tools.QuerySamGov do
  @moduledoc """
  ...
  use Jido.Action,
    ...
    schema: [
      ...
      naics_codes: [type: {:array, :string}, default: ["541330", "541512"], doc: "NAICS codes to filter by"],
  ...
  def run(params, context) do
    ...
    if is_nil(api_key) do
      ...
      Logger.info("[QuerySamGov] Searching with params: #{inspect(Map.delete(query_params, :api_key))}")
