defmodule GnomeHub.Agents.Tools.GitCommit do
  @moduledoc """
  ...
  use Jido.Action,
    name: "git_commit",
    description: "Create a git commit. Stage files first with git add, then commit with a message.",
    schema: [
      message: [type: :string, required: true, doc: "Commit message"],
      add_all: [type: :boolean, default: false, doc: "Stage all changes before committing (git add -A)"]
    ]
