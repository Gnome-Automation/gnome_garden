defmodule GnomeHub.Agents.Tools.MemoryRecall do
  @moduledoc """
  ...
  use Jido.Action,
    name: "memory_recall",
    description: "Search memories by a query string. Finds memories where the key or content contains the query.",
    schema: [
