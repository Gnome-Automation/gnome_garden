defmodule GnomeHub.Agents.Tools.MemoryRemember do
  @moduledoc """
  ...
  use Jido.Action,
    ...
    description: "Store information in persistent memory for later recall. Use for facts, patterns, decisions, or preferences you want to remember.",
    schema: [
      key: [type: :string, required: true, doc: "A unique identifier for this memory (e.g., 'user_preference_theme')"],
      content: [type: :string, required: true, doc: "The information to remember"],
      type: [type: :string, default: "fact", doc: "Type: fact, pattern, decision, preference, or context"],
      namespace: [type: :string, default: "global", doc: "Namespace for organizing memories (e.g., 'project_x')"]
    ]
